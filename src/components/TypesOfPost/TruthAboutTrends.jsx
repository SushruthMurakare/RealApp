...
const TruthAboutTrends = ({typeOfPost}) => {
    ...
    <div className="max-w-md mx-auto p-6 bg-white rounded-lg shadow-lg space-y-4">
      ...
      <>
        <label className="block text-gray-600 font-medium">
          Provide the URL to the trend you are referring
        </label>
        <input
          type="text"
        //   value={postUrl}
        ...
        />
        <label className="block text-gray-600 font-medium">
          Write about the truth behind this trend and educate people
        </label>
        <textarea
        ...
        />
        <label className="block text-gray-600 font-medium">
          How much real score would you like to provide?
        </label>
        <input
          type="range"
          min="0"
        ...
        <p className="text-xs text-red-500">
          Disclaimer: If the real score you provide is greater than the overall
          average real score this post gets, your post will gradually start to
          fade away from your followers' feed.
        </p>
      </>
...
export default TruthAboutTrends;
